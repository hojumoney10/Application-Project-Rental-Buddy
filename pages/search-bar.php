                ...
                <tr>
                    <div class="input-group">
                        <td>
                            ...
                            <input type="submit" class="btn btn-primary btn-crud" name="btn-search" value="Search">
                            <input type="submit" class="btn btn-secondary btn-crud" name="btn-search-clear" value="Clear">
                        </td>
                    </div>
                </tr>
            </tbody>
